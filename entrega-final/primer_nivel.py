...
# Falta Sotiemhoci/Satiemesp, Conocunifila, Filtrounifila, Comptmpunif, Limp2, Sat1, Sat3, Citapre(1) -> Diascita
columnas_interes_1 = ['Folio', 'Servatn', 'Tipopac', 'Probsal', 'Citapre', 'Comocita', 'Diascita', 'Tmedreg2', '', 'Totorpase1', 'Tiem_Esp1', 'Nivel', 'Unidad', 'Promedio_Diario2016']
primer_nivel = primer_nivel[columnas_interes_1]
### Son los pacientes que vienen a consulta médica
